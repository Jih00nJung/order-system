...
const UserOrderDetail = () => {
    ...
    return (
        <main className="flex-1 bg-surface overflow-y-auto p-md lg:p-xl custom-scroll">
            <div className="max-w-[1024px] mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-md mb-xl">
                    <div>
                        <div className="flex items-center gap-sm mb-xs">
                            <button className="text-on-surface-variant hover:text-primary transition-colors flex items-center p-2 rounded-full hover:bg-surface-variant" onClick={() => navigate('/mypage-orders')}>
                                <span className="material-symbols-outlined text-[18px]">arrow_back</span>
                            </button>
                            <span className="font-label-caps text-label-caps px-sm py-xs rounded bg-surface-container-high text-on-surface-variant">일반 주문</span>
                        </div>
                    ...
                    <div className="flex items-center gap-sm">
                        <button className="font-title-sm text-title-sm px-4 py-2 rounded-lg bg-surface-container-lowest border border-outline-variant text-on-surface hover:bg-surface-container-low transition-all shadow-sm flex items-center gap-2">
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left font-data-tabular text-data-tabular">
                                    ...
                                    <tbody className="divide-y divide-surface-variant">
                                        <tr className="hover:bg-surface-container-low transition-colors cursor-pointer group" onClick={() => navigate('/store-detail')}>
                                            <td className="px-lg py-md group-hover:opacity-80 transition-opacity">
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-lg">
                        ...
                        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-lg shadow-sm">
                            <div className="flex justify-between items-center mb-md">
                                <h3 className="font-title-sm text-title-sm text-on-surface">내 정보</h3>
                            </div>
