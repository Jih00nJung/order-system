...
@SpringBootTest
public class OrderFacadeRandomTest {
    ...
    void setUp() {
        ...
        for (int i = 0; i < 500; i++) {
            Product product = Product.builder()
                    .seller(testSeller)
                    .name("Order Concurrency Test Product " + i)
                    .price(1000)
                    .stock(1000)
    ...
    @Test
    void createOrderRandomConcurrencyTest() throws InterruptedException {
        int threadCount = 10;
        ...
        System.out.println("====== 낙관적 락 분산(Low Contention) 테스트 결과 ======");
